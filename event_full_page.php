            ...
            <div class="col-lg-9 col-12">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets/img/self_images/holi (1).png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/img/self_images/holi (2).png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/img/self_images/holi (3).png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        ...
                        <h6>
                        This event was touted as the biggest Holi party in Kakinada, promising attendees a vibrant and memorable experience.
                        </h6>
