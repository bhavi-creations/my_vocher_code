<section id="bottomAdBanner" class="sticky-bottom-ad">
        <!-- Close button at the top-right corner of the entire row -->
        <button class="close-bottom-ad" onclick="closeBottomAd()">✖</button>
        
        <!-- Image centered in the row -->
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    ...
                    <ul class="dot list-unstyled">
                        <a href=""><li>All brands</li></a>
                        <a href=""><li>Exclusive discounts</li></a>
                        <a href=""><li>Seasonal Deals & Offers</li></a>
                        <a href=""><li>Student discounts</li></a>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>Helpful info & Contact <br>Details</h5>
                    <ul class="dot list-unstyled">
                        <a href=""><li>FAQS</li></a>
                        <a href=""><li>Contact Us</li></a>
                        <a href=""><li>Community Codes</li></a>
                        <a href=""><li>Advertise with us</li></a>
                        <a href=""><li>Press Centre</li></a>
                    </ul>
                </div>
                <div class="col-md-4">
                    ...
                    <ul class="dot list-unstyled">
                        <a href=""><li>Blog</li></a>
                        <a href=""><li>How We Make Money</li></a>
                        <a href=""><li>How to Use a Voucher Code</li></a>
                        <a href=""><li>Useful information</li></a>
                    </ul>
                </div>
            </div>
        </div>
