    ...
    <h1 class="text-center my-4">Thirumala </h1>
                    ...
                    <div class="container">
                        <a href="tirumala1.php">
                            <div class="card bg-dark text-white shadow-lg  d-flex flex-column align-items-center"
                                ...
                                <h3 class="mt-2 p-3 text-center  list_page_test_tittle flex-grow-1 text-white"> Thirumala : Screen 1 </h3>
                            </div>
                        </a>
                    </div>
